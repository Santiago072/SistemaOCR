        ...
        <div class="upload-actions-panel">
            <div id="processingIndicator" class="processing-indicator" style="display: none;">
                <div class="processing-header">
                    ...
                    <div class="processing-timer" style="margin-left: auto; display: flex; align-items: center; gap: 6px; background: #f1f5f9; padding: 4px 12px; border-radius: 9999px; font-weight: 600; color: #0f172a; font-size: 0.9rem; border: 1px solid #cbd5e1;">
